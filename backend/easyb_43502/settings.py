"""
Django settings for easyb_43502 project.
...
WSGI_APPLICATION = 'easyb_43502.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "easyb_43502 API",
    "DESCRIPTION": "API documentation for easyb_43502 App",
    "VERSION": "v1",
}
